package casestudy.task3.Controller;

import casestudy.task3.models.House;
import casestudy.task3.models.Room;
import casestudy.task3.models.Service;
import casestudy.task3.models.Villa;
...
public class MainController {
    private static String pathVilla = "src/casestudy/task3/data/Villa.csv";
    private static String pathHouse = "src/casestudy/task3/data/House.csv";
    private static String pathRoom = "src/casestudy/task3/data/Room.csv";
